...
const translations: Record<Language, Record<string, any>> = {
  'zh-TW': {
    ...
    'fortune.showPrompt': '顯示 提示詞',
    'fortune.hidePrompt': '隱藏 提示詞',
    'fortune.copyPrompt': '複製 提示詞',
    'fortune.copied': '已複製',
    ...
    'ai.start': '開始解讀',
    'ai.loading': '解讀中',
    'ai.showPrompt': '顯示 提示詞',
    'ai.hidePrompt': '隱藏 提示詞',
    ...
    'form.inputMode': '輸入模式',
    'form.solarInput': '西元',
    'form.lunarInput': '農曆干支',
    'form.date': '出生日期',
    'form.solarCalendar': '陽曆',
    'form.dateHint': '請輸入陽曆（公曆）日期，系統會自動轉為農曆排盤',
    'form.lunarDateHint': '請輸入農曆年月日與時辰，年份會同步顯示天干地支',
    'form.birthTime': '出生時間',
    'form.shichen': '出生時辰',
    'form.leapMonth': '閏月',
    ...
    'settings.showPalaceTransformation': '顯示宮位轉換',
  ...
  'zh-CN': {
    ...
    'fortune.cancelAnalyze': '✕ 返回修改',
    'fortune.showPrompt': '显示 提示詞',
    'fortune.hidePrompt': '隐藏 提示詞',
    'fortune.copyPrompt': '复制 提示詞',
    'fortune.copied': '已复制',
    ...
    'ai.start': '开始解读',
    'ai.loading': '解读中',
    'ai.showPrompt': '显示 提示詞',
    'ai.hidePrompt': '隐藏 提示詞',
    'ai.promptPreview': '提示詞 预览',
    ...
    'form.inputMode': '输入模式',
    'form.solarInput': '公历',
    'form.lunarInput': '农历干支',
    'form.date': '出生日期',
    'form.solarCalendar': '阳历',
    'form.dateHint': '请输入阳历（公历）日期，系统会自动转为农历排盘',
    'form.lunarDateHint': '请输入农历年月日与时辰，年份会同步显示天干地支',
    'form.birthTime': '出生时间',
    'form.shichen': '出生时辰',
    'form.leapMonth': '闰月',
    ...
    'settings.showPalaceTransformation': '显示宫位转换',
