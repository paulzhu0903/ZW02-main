...
const translations: Record<Language, Record<string, any>> = {
  'zh-TW': {
    ...
    'ai.start': '開始解讀',
    'ai.loading': '解讀中',
    'ai.showPrompt': '顯示 Prompt（測試）',
    'ai.hidePrompt': '隱藏 Prompt',
    'ai.promptPreview': 'Prompt 預覽',
    'ai.promptHintNoApi': '未配置 API 前，也可先點擊「顯示 Prompt（測試）」檢查提示詞。',
  ...
  'zh-CN': {
    ...
    'ai.start': '开始解读',
    'ai.loading': '解读中',
    'ai.showPrompt': '显示 Prompt（测试）',
    'ai.hidePrompt': '隐藏 Prompt',
    'ai.promptPreview': 'Prompt 预览',
    'ai.promptHintNoApi': '未配置 API 前，也可先点击「显示 Prompt（测试）」检查提示词。',
